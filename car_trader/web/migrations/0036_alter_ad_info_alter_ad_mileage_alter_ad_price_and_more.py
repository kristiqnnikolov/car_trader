...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('web', '0035_alter_ad_mileage_alter_ad_price'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='ad',
            name='info',
            field=car_trader.web.models.MyCustomCharField(blank=True, max_length=100),
        ),
        migrations.AlterField(
            model_name='ad',
            name='mileage',
        ...
        migrations.AlterField(
            ...
            name='phone_number',
            field=models.CharField(blank=True, max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(100, message='Телефонният номер трябва да бъде с дължина от 10 цифри')]),
        ),
    ]
